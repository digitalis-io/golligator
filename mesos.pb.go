...
func init() {
	proto.RegisterEnum("golligator.Status", Status_name, Status_value)
	proto.RegisterEnum("golligator.TaskState", TaskState_name, TaskState_value)
	proto.RegisterEnum("golligator.FrameworkInfo_Capability_Type", FrameworkInfo_Capability_Type_name, FrameworkInfo_Capability_Type_value)
	proto.RegisterEnum("golligator.Value_Type", Value_Type_name, Value_Type_value)
	proto.RegisterEnum("golligator.Offer_Operation_Type", Offer_Operation_Type_name, Offer_Operation_Type_value)
	proto.RegisterEnum("golligator.TaskStatus_Source", TaskStatus_Source_name, TaskStatus_Source_value)
	proto.RegisterEnum("golligator.TaskStatus_Reason", TaskStatus_Reason_name, TaskStatus_Reason_value)
	proto.RegisterEnum("golligator.ACL_Entity_Type", ACL_Entity_Type_name, ACL_Entity_Type_value)
	proto.RegisterEnum("golligator.Volume_Mode", Volume_Mode_name, Volume_Mode_value)
	proto.RegisterEnum("golligator.ContainerInfo_Type", ContainerInfo_Type_name, ContainerInfo_Type_value)
	proto.RegisterEnum("golligator.ContainerInfo_DockerInfo_Network", ContainerInfo_DockerInfo_Network_name, ContainerInfo_DockerInfo_Network_value)
	proto.RegisterEnum("golligator.DiscoveryInfo_Visibility", DiscoveryInfo_Visibility_name, DiscoveryInfo_Visibility_value)
}
